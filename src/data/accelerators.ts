...
export const ACCELERATORS: AcceleratorSpec[] = [
  ...
  },
  {
    ...
    // 20-core Arm Grace CPU sharing 128GB LPDDR5X. Grouped with the consumer
    // NVIDIA cards, not the datacenter Blackwell parts: it's a desktop
    // developer machine, and like the Apple SoCs the capacity below is unified
    // system memory shared with the OS and CPU, so usable headroom is
    // materially lower than 128GB.
